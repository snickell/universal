...
4. Details of the HTML element:
  ...
  - the <body> tag:
    a. should contain exactly one element: <div id="screen">
    b. all other on-screen elements should be descendants of #screen
    c. the body tag should not include any attributes, including style
    d. the screen div can contain any number of <style> blocks
